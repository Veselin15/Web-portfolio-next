            ...
            {filteredProjects.map((project) => (
              ...
              >
                {activeTab === "Software" ? (
                  ...
                  <div className="group h-full bg-slate-900/50 border border-slate-800 rounded-2xl p-6 flex flex-col hover:border-sky-500/50 hover:bg-slate-900 transition-all duration-300 hover:shadow-2xl hover:shadow-sky-500/10">
                    <div className="flex justify-between items-start mb-4">
                      <div className="p-3 bg-sky-500/10 rounded-lg text-sky-400">
                        <Layers size={24} />
                      </div>
                      <div className="flex gap-2">
                        {/* Only GitHub Link for Software */}
                        {project.repoUrl && (
                          <a href={project.repoUrl} target="_blank" className="text-slate-400 hover:text-white transition-colors">
                            <Github size={20} />
                          </a>
                        )}
                      </div>
